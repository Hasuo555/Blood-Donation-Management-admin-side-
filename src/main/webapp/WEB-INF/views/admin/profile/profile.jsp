...
<div class="page-header">
    ...
    <p class="page-subtitle">View and update your admin account</p>
</div>
        ...
        <div class="card-body">
            <form method="post" action="<c:url value='/admin/profile/update-name'/>">
                ...
                <dl class="detail-list mt-3">
                    <dt>Email</dt><dd>${fn:escapeXml(admin.account.email)}</dd>
                    <dt>Phone</dt><dd>${fn:escapeXml(admin.account.phone)}</dd>
                    <dt>Role</dt><dd>${admin.account.role}</dd>
                    <dt>Account Created</dt><dd>${admin.account.createdAt.toLocalDate()}</dd>
                    <dt>Last Login</dt><dd>${admin.account.lastLoginAt != null ? admin.account.lastLoginAt : '—'}</dd>
                </dl>
