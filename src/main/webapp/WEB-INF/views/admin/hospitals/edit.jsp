        ...
        <form method="post" action="<c:url value='/admin/hospitals/${hospital.id}/edit'/>"
            ...
            <div class="form-group">
                ...
                <input type="text" id="name" name="name"
                       value="${fn:escapeXml(hospitalUpdateDTO.name)}"
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="tel" id="phone" name="phone"
                           value="${fn:escapeXml(hospitalUpdateDTO.phone)}"
                           class="form-control" required/>
                </div>
                <div class="form-group">
                    <label for="email" class="form-label">Email</label>
                    <input type="email" id="email" name="email"
                           value="${fn:escapeXml(hospitalUpdateDTO.email)}"
                           class="form-control"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="detailAddress" name="detailAddress"
                       value="${fn:escapeXml(hospitalUpdateDTO.detailAddress)}"
                       class="form-control" required/>
            </div>
            <div class="form-row">
                <div class="form-group">
            ...
            <div class="form-actions">
                ...
                <a href="<c:url value='/admin/hospitals/${hospital.id}'/>" class="btn btn-secondary">Cancel</a>
            </div>
        </form>
    </div>
</div>
