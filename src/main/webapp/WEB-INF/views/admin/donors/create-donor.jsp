      ...
      <%@ include file="../../layout/header.jsp" %>
        ...
        <%--============================================================Inline styles specific to the Create Donor page.
          ...
          <style>
            ...
            .cred-modal-footer {
              padding: 1rem 1.5rem;
              border-top: 1px solid rgba(9, 238, 5, 0.956);
              display: flex;
              gap: .75rem;
              justify-content: flex-end;
            }
          ...
          <%--============================================================Page
            ...
            <%--============================================================Credentials Modal (shown after successful
              creation)============================================================--%>
                    ...
                    <div class="cred-modal-body">
                      <div class="cred-warning">
                        ...
                        <span>This is the <strong>only time</strong> the temporary password will be shown.
                          Please copy the credentials before closing.</span>
                      </div>
                      ...
                      <div class="cred-field">
                        ...
                        <div class="cred-value-box">
                          ...
                          <button class="cred-copy-btn" type="button" onclick="copyToClipboard('credUsername', this)">
                            📋 Copy
                          </button>
                        </div>
                      </div>
                      ...
                      <div class="cred-field">
                        ...
                        <div class="cred-value-box">
                          ...
                          <button class="cred-copy-btn" type="button" onclick="copyToClipboard('credPassword', this)">
                            📋 Copy
                          </button>
                        </div>
                      </div>
              ...
              <%--============================================================Global success / error
                ...
                <%--============================================================Main form (single
                  ...
                  <div class="create-donor-grid">
                    <div>
                      <form method="post" action="<c:url value='/admin/donors/create'/>" enctype="multipart/form-data"
                        id="createDonorForm" novalidate>
                            ...
                            <div class="form-section-body">
                              ...
                              <div class="field-row">
                                <div class="field-group">
                                  ...
                                  <input id="name" name="name" type="text"
                                    ...
                                    value="<c:out value='${donorCreateDTO.name}'/>" maxlength="255" required />
                                  <c:if test="${not empty fieldErrors.name}"><span
                                      class="field-error">${fn:escapeXml(fieldErrors.name)}</span></c:if>
                                </div>
                                <div class="field-group">
                                  ...
                                  <input id="phone" name="phone" type="tel"
                                    ...
                                    value="<c:out value='${donorCreateDTO.phone}'/>" maxlength="20" required />
                                  <c:if test="${not empty fieldErrors.phone}"><span
                                      class="field-error">${fn:escapeXml(fieldErrors.phone)}</span></c:if>
                                </div>
                              </div>
                              ...
                              <div class="field-row">
                                <div class="field-group">
                                  ...
                                  <c:if test="${not empty fieldErrors.dateOfBirth}"><span
                                      class="field-error">${fn:escapeXml(fieldErrors.dateOfBirth)}</span></c:if>
                                </div>
                                <div class="field-group">
                                  ...
                                  <select id="gender" name="gender"
                                    class="field-select ${not empty fieldErrors.gender ? 'is-error' : ''}" required>
                                    <option value="">— Select Gender —</option>
                                    <option value="MALE" ${donorCreateDTO.gender=='MALE' ? 'selected' : '' }>Male
                                    </option>
                                    <option value="FEMALE" ${donorCreateDTO.gender=='FEMALE' ? 'selected' : '' }>Female
                                    </option>
                                    <option value="OTHER" ${donorCreateDTO.gender=='OTHER' ? 'selected' : '' }>Other
                                    </option>
                                  </select>
                                  <c:if test="${not empty fieldErrors.gender}"><span
                                      class="field-error">${fn:escapeXml(fieldErrors.gender)}</span></c:if>
                                </div>
                              </div>
                              ...
                              <div class="field-row">
                                <div class="field-group">
                                  ...
                                  <input id="email" name="email" type="email" class="field-input"
                                    value="<c:out value='${donorCreateDTO.email}'/>" maxlength="255" required />
                                </div>
                                <div class="field-group">
                                  ...
                                  <select id="bloodTypeId" name="bloodTypeId" class="field-select">
                                    ...
                                    <c:forEach items="${bloodTypes}" var="bt">
                                      <option value="${bt.id}" ${donorCreateDTO.bloodTypeId==bt.id ? 'selected' : '' }>
                            ...
                            <div class="form-section">
                              <div class="form-section-header">
                                <div class="section-icon">
                                  <svg viewBox="0 0 24 24">
                                    <path
                                      d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 14H4V6h16v12zM6 10h12v2H6zm0 4h8v2H6z" />
                                  </svg>
                                </div>
                              ...
                              <div class="form-section-body">
                                ...
                                <div class="field-group">
                                  ...
                                  <c:if test="${not empty fieldErrors.nrcNumber}"><span
                                      class="field-error">${fn:escapeXml(fieldErrors.nrcNumber)}</span></c:if>
                                </div>
                                ...
                                <div class="field-row">
                                  <div class="field-group">
                                    ...
                                    <div class="file-upload-area ${not empty fieldErrors.nrcFront ? 'is-error' : ''}"
                                      id="nrcFrontArea">
                                  ...
                                  <div class="field-group">
                                    ...
                                    <div class="file-upload-area ${not empty fieldErrors.nrcBack ? 'is-error' : ''}"
                                      id="nrcBackArea">
                                ...
                                <div class="form-section-body">
                                  ...
                                  <div class="field-group">
                                    ...
                                    <input id="detailAddress" name="detailAddress" type="text"
                                      ...
                                      placeholder="House number / Street" maxlength="500" required />
                                    <c:if test="${not empty fieldErrors.detailAddress}"><span
                                        class="field-error">${fn:escapeXml(fieldErrors.detailAddress)}</span></c:if>
                                  </div>

                                  <div class="field-row">
                                    <div class="field-group">
                                      <label class="field-label" for="township">Township <span
                                          class="req">*</span></label>
                                      <input id="township" name="township" type="text"
                                        class="field-input ${not empty fieldErrors.township ? 'is-error' : ''}"
                                        value="<c:out value='${donorCreateDTO.township}'/>" maxlength="100" required />
                                      <c:if test="${not empty fieldErrors.township}"><span
                                          class="field-error">${fn:escapeXml(fieldErrors.township)}</span></c:if>
                                    </div>
                                    <div class="field-group">
                                      <label class="field-label" for="division">Division / Region <span
                                          class="req">*</span></label>
                                      <input id="division" name="division" type="text"
                                        class="field-input ${not empty fieldErrors.division ? 'is-error' : ''}"
                                        value="<c:out value='${donorCreateDTO.division}'/>" maxlength="100" required />
                                      <c:if test="${not empty fieldErrors.division}"><span
                                          class="field-error">${fn:escapeXml(fieldErrors.division)}</span></c:if>
                                    </div>
                                  </div>
                                  ...
                                  <div class="field-row">
                                    <div class="field-group">
                                      ...
                                      <input id="country" name="country" type="text" class="field-input"
                                ...
                                <div class="form-section">
                                  ...
                                  <div class="form-section-body">
                                    <div class="alert-banner alert-banner-info" style="margin-bottom:1rem">
                                      ...
                                      <span>Leave both fields empty to <strong>auto-generate</strong> a secure
                                        10-character
